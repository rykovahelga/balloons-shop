      ...
      <div class="header__container container">
        <div class="header__inner">
            ...
            <div class="header__wrap-search">
              <svg class="header__img-search" width="20" height="20" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M21 3C11.6211 3 4 10.6211 4 20C4 29.3789 11.6211 37 21 37C24.7109 37 28.1406 35.8047 30.9375 33.7812L44.0938 46.9062L46.9062 44.0938L33.9062 31.0625C36.4609 28.0859 38 24.2227 38 20C38 10.6211 30.3789 3 21 3ZM21 5C29.2969 5 36 11.7031 36 20C36 28.2969 29.2969 35 21 35C12.7031 35 6 28.2969 6 20C6 11.7031 12.7031 5 21 5Z" fill="#6D6D6D"/>
              </svg>
              <input class="header__input-search" type="text" placeholder="Поиск по сайту">
            </div>

            <div class="header__wrap-link">
               <a class="header__discounts-link" href="#"> <img src="./src/images/header/percentage.svg" alt="icon burger">
               </a>
            </div>

            <div class="header__wrap-link">
           <a class="header__discounts-link header__btn-basket" href="#">
        ...
        <div class="header__categories-wrap">
          <ul class="header__categories-list">
            <li>
              <a href="/" class="header__categories-item header__categories-item_logo">
                <img src="./src/images/header/logo.svg" alt="logo">
              </a>
            </li>
            <li>
              <a href="#" class="header__categories-item">
                Латексные шары
              </a>
            </li>
            <li>
      ...
      <div class="header__container container">
        ...
        <div class="header__main">
          ...
          <button class="header__btn">
            <img src="./src/images/header/lines-btn.svg" alt="lines button">
            <p>Католог</p>
          </button>
          ...
          <ul class="header__burger-list">
            <li class="header__burger-item">
              <a href="#"  class="header__item-text item-text_active ">Акции</a>
            </li>
            <li class="header__burger-item">
              <a href="#"  class="header__item-text">Контакты</a>
            </li>
          ...
          <div class="header__categories-wrap">
            <ul class="header__categories-list">
              ...
              <li class="header__opening-hours">
                <p class="header__opening-hours_title">Режим работы</p>
                <p class="header__opening-hours_desc">Круглосуточно</p>
              </li>
            </ul>
          </div>
